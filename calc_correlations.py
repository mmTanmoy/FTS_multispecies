...
# FTS_polyampholytes_multispecies.py
Nx = 32
a = np.sqrt(1./6.)
dx = a
V = (Nx*dx)**3.
...
df_all = pd.DataFrame()
starting_step = 20000   # Initial CL-step after equilibration to start sampling
ending_step   = 54001   # Ending CL-step of sampling
...
for run in range(runs):
    ...
    for cl_step in range(starting_step, ending_step, interval):
        ...
        fname = '../densities/density_sv28_sv24_' + str(run) + \
...
outfile = 'sv28-sv24_correlations_cross_self0_self1.txt'
